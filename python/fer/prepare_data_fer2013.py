...
def train_data_shift(train_root):
    with open(TRAIN_LABEL_FILE, 'r') as tlf:
        line = tlf.readline()
        while line:
            print(line)
...
#split_csv(csv_file)
#pixel_to_img()
#label_txt(TRAIN_LABEL_FILE, FIX_TRAIN_ROOT)
#train_data_shift(FIX_TRAIN_ROOT)
#label_txt(TRAIN_LABEL_FILE, FIX_TRAIN_ROOT)
#label_txt(VAL_LABEL_FILE, FIX_VAL_ROOT)
